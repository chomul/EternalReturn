...
> 체크리스트 [`05_GameplayTag_체계.md`](../../2_Checklist/F00_GAS기반세팅/05_GameplayTag_체계.md)
...
[전투판정 문서](../../0_GameDesign/Systems/전투판정_상태이상_역기획서.md) §3의 CC 목록과
[스킬 문서](../../0_GameDesign/Systems/스킬_프레임워크_역기획서.md) §8의 형태 목록에서 나온다.
