...
- [x] 어빌리티의 `ActivationBlockedTags` 에 그 태그를 넣는다  → ✅ F07-01 에서 확인 — GA_Test 에 State.Block.Skill 한 줄로 기절 중 Q 차단
...
- [x] ⭐ 서버에서 기절 GE 부여 → 클라의 이동 · 평타 · 스킬이 **전부** 막힌다  → ✅ 이동 · ✅ 스킬 (F07-01) · ✅ **평타** (F07-07 — `State.Block.BasicAttack` 으로 평타·강화 평타 차단, 사용자 확인 2026-09-15)
