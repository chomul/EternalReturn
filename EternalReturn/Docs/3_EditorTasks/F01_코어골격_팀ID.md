...
> 체크리스트 [`../Checklist/F01_코어골격_팀ID/00_기능_완료판정.md`](../2_Checklist/F01_코어골격_팀ID/00_기능_완료판정.md)
...
[`../Checklist/F01_코어골격_팀ID/00_기능_완료판정.md`](../2_Checklist/F01_코어골격_팀ID/00_기능_완료판정.md)
의 **「통합 검증」** 5건을 채운다.
